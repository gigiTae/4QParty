...
namespace FQParty.Session.CommonSession
{
    ...
    public partial class SessionInfoElement : VisualElement
    {
        ...
        public SessionInfoElement()
        {
            ...
            sessionInfoHeader.AddToClassList(UITheme.Header);
            sessionInfoHeader.AddToClassList(UITheme.HeaderSpaceBottom);
            Add(sessionInfoHeader);

            var stateLabel = new Label();
            stateLabel.AddToClassList(UITheme.Header);
            stateLabel.AddToClassList(UITheme.HeaderXSmall);
            stateLabel.AddToClassList(UITheme.SpaceBottom);
            ...
            scrollViewParent.AddToClassList(UITheme.ScrollView);
            ...
            sessionDataHeader.AddToClassList(UITheme.Header);
            sessionDataHeader.AddToClassList(UITheme.HeaderSmall);
            sessionDataHeader.AddToClassList(UITheme.SpaceBottomSmall);
            scrollViewParent.Add(sessionDataHeader);

            var sessionIdLabel = new Label();
            sessionIdLabel.AddToClassList(UITheme.Label);
            ...
            maxPlayersLabel.AddToClassList(UITheme.Label);
            ...
            isPrivateLabel.AddToClassList(UITheme.Label);
            ...
            isLockedLabel.AddToClassList(UITheme.Label);
            ...
            sessionCodeLabel.AddToClassList(UITheme.Label);
            ...
            hostIDLabel.AddToClassList(UITheme.Label);
            ...
            isHostLabel.AddToClassList(UITheme.Label);
            isHostLabel.AddToClassList(UITheme.SpaceBottomSmall);
            ...
            var propertiesListView = new ListView
            {
                ...
                makeHeader = () =>
                {
                    ...
                    sessionPropertiesHeader.AddToClassList(UITheme.Header);
                    sessionPropertiesHeader.AddToClassList(UITheme.HeaderXSmall);
                    sessionPropertiesHeader.AddToClassList(UITheme.HeaderXSmall);
                ...
                makeItem = () =>
                {
                    ...
                    container.AddToClassList(UITheme.Label);

                    var keyLabel = new Label
                    {
                        name = k_KeyLabelPropertyName
                    };
                    keyLabel.AddToClassList(UITheme.Label);
                    ...
                    visibilityLabel.AddToClassList(UITheme.Label);
                    ...
                    valueLabel.AddToClassList(UITheme.Label);
            ...
            propertiesListView.AddToClassList(UITheme.Label);
            propertiesListView.AddToClassList(UITheme.SpaceBottom);
            ...
            var playerStatsListView = new ListView
            {
                ...
                makeHeader = () =>
                {
                    ...
                    playerDataHeader.AddToClassList(UITheme.Header);
                    playerDataHeader.AddToClassList(UITheme.HeaderSmall);
                    playerDataHeader.AddToClassList(UITheme.SpaceBottomSmall);
                    return playerDataHeader;
                },
                makeItem = () =>
                {
                    var container = new VisualElement();
                    container.AddToClassList(UITheme.SpaceBottom);

                    var playerHeaderLabel = new Label
                    {
                        name = k_PlayerHeaderName
                    };
                    playerHeaderLabel.AddToClassList(UITheme.Header);
                    playerHeaderLabel.AddToClassList(UITheme.HeaderXSmall);
                    playerHeaderLabel.AddToClassList(UITheme.SpaceBottomSmall);
                    ...
                    playerIdLabel.AddToClassList(UITheme.Label);
                    ...
                    playerJoinedLabel.AddToClassList(UITheme.Label);
                    ...
                    playerLastUpdatedLabel.AddToClassList(UITheme.Label);
                    playerLastUpdatedLabel.AddToClassList(UITheme.SpaceBottomSmall);
                    ...
                    var playerPropertiesList = new ListView
                    {
                        ...
                        makeHeader = () =>
                        {
                            ...
                            playerPropertiesHeader.AddToClassList(UITheme.Header);
                            playerPropertiesHeader.AddToClassList(UITheme.HeaderXSmall);
                            playerPropertiesHeader.AddToClassList(UITheme.SpaceBottomSmall);
                ...
                bindItem = (element, index) =>
                {
                    ...
                    playerPropertiesList.makeItem = () =>
                    {
                        ...
                        propertyKeyLabel.AddToClassList(UITheme.Label);
                        ...
                        propertyValueLabel.AddToClassList(UITheme.Label);
                        ...
                        propertyVisibilityLabel.AddToClassList(UITheme.Label);
            ...
            playerStatsListView.AddToClassList(UITheme.ListViewNoHover);
